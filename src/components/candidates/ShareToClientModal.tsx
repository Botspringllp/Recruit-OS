          ...
          {successData ? (
            <div className="py-6 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[11px] font-bold text-amber-700 bg-amber-50 py-1 px-3 rounded-lg inline-block border border-amber-200 mt-2">
                  Client Email sent to: <strong>divyanshu@botspring.in</strong>
                </p>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 text-xs">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 text-[11px] font-bold text-slate-600">
                📧 Email target: <span className="text-slate-900 font-black">divyanshu@botspring.in</span>
              </div>
