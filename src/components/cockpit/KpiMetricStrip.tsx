  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      {metrics.map(metric => {
        const content = (
          <div
            className="h-full rounded-2xl bg-white border border-slate-200 p-5 flex flex-col justify-between shadow-sm shadow-slate-200/50 hover:shadow-md hover:border-indigo-400 transition-all duration-200 group cursor-pointer"
          >
            {/* Header row */}
